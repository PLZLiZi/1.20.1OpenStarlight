...
import net.daichang.starlightbyte.javassist.bytecode.ConstantAttribute;
import net.daichang.starlightbyte.javassist.bytecode.Descriptor;
import net.daichang.starlightbyte.javassist.bytecode.EnclosingMethodAttribute;
import net.daichang.starlightbyte.javassist.bytecode.FieldInfo;
import net.daichang.starlightbyte.javassist.bytecode.InnerClassesAttribute;
...
import net.daichang.starlightbyte.javassist.compiler.AccessorMaker;
...
class CtClassType extends CtClass {
   ...
   /**
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return net.daichang.starlightbyte.javassist.bytecode.annotation.AnnotationImpl.make(
    ...
    /**
     * @see net.daichang.starlightbyte.javassist.CtClass#prune()
     * @see net.daichang.starlightbyte.javassist.CtClass#stopPruning(boolean)
     */
    @Override
    public void prune()
    {
