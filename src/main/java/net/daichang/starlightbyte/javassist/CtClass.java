...
public abstract class CtClass {
     ...
     */
    public net.daichang.starlightbyte.javassist.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see net.daichang.starlightbyte.javassist.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see net.daichang.starlightbyte.javassist.bytecode.SignatureAttribute.ClassSignature#encode()
     ...
     *
     * @see net.daichang.starlightbyte.javassist.CtConstructor
     */
     ...
     * are not included.
     *
     * @see net.daichang.starlightbyte.javassist.CtMethod
     */
     ...
     *
     * @see net.daichang.starlightbyte.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see net.daichang.starlightbyte.javassist.CtField.Initializer#byExpr(String)
     * @see net.daichang.starlightbyte.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see net.daichang.starlightbyte.javassist.bytecode.AttributeInfo
     */
