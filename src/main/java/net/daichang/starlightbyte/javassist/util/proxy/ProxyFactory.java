...
package net.daichang.starlightbyte.javassist.util.proxy;
...
import net.daichang.starlightbyte.javassist.bytecode.DuplicateMemberException;
 ...
 * {@link net.daichang.starlightbyte.javassist.util.proxy.ProxyObjectOutputStream} and {@link net.daichang.starlightbyte.javassist.util.proxy.ProxyObjectInputStream}
...
public class ProxyFactory {
     ...
     * @see net.daichang.starlightbyte.javassist.CtClass#setGenericSignature(String)
     * @since 3.26
     */
