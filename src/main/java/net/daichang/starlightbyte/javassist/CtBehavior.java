...
package net.daichang.starlightbyte.javassist;

import net.daichang.starlightbyte.javassist.bytecode.AccessFlag;
import net.daichang.starlightbyte.javassist.bytecode.AnnotationsAttribute;
import net.daichang.starlightbyte.javassist.bytecode.AttributeInfo;
...
import net.daichang.starlightbyte.javassist.bytecode.ExceptionsAttribute;
import net.daichang.starlightbyte.javassist.bytecode.LineNumberAttribute;
import net.daichang.starlightbyte.javassist.bytecode.LocalVariableAttribute;
import net.daichang.starlightbyte.javassist.bytecode.LocalVariableTypeAttribute;
...
import net.daichang.starlightbyte.javassist.bytecode.ParameterAnnotationsAttribute;
import net.daichang.starlightbyte.javassist.bytecode.SignatureAttribute;
import net.daichang.starlightbyte.javassist.bytecode.StackMap;
import net.daichang.starlightbyte.javassist.bytecode.StackMapTable;
import net.daichang.starlightbyte.javassist.compiler.CompileError;
import net.daichang.starlightbyte.javassist.compiler.Javac;
import net.daichang.starlightbyte.javassist.expr.ExprEditor;
 ...
 *
 * <p>To directly read or modifySti bytecode, obtain <code>MethodInfo</code>
 * objects.
 *
 * @see #getMethodInfo()
 */
public abstract class CtBehavior extends CtMember {
     ...
     * class file.
     *
     * <p>If you modifySti the bytecode through the returned
     ...
     *
     * @see net.daichang.starlightbyte.javassist.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * a descriptor.
     *
     * @see net.daichang.starlightbyte.javassist.bytecode.Descriptor
     ...
     * It represents parameter types including type variables.
     * See {@link net.daichang.starlightbyte.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see net.daichang.starlightbyte.javassist.bytecode.SignatureAttribute.MethodSignature#encode()
     * @since 3.17
     */
    @Override
     ...
     * See {@link net.daichang.starlightbyte.javassist.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see net.daichang.starlightbyte.javassist.runtime.Cflow
     */
     ...
     *
     * @param converter         specifies how to modifySti.
     */
     ...
     *
     * @param editor            specifies how to modifySti.
     * @see net.daichang.starlightbyte.javassist.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
    ...
    */
     ...
     * <code>modifySti</code> set to <code>false</code>.
     *
     * @param lineNum   the line number.  The bytecode is inserted at the
     *                  beginning of the code at the line specified by this
     *                  line number.
     ...
     * @param src       the source code representing the inserted bytecode.
     *                  It must be a single statement or block.
     *                  If modifySti is false, the value of src can be null.
     * @return      the line number at which the bytecode has been inserted.
     */
