 ...
 * modifySti a method body.  The overall architecture is similar to the
 * strategy pattern.
 *
 ...
 * <code>edit()</code> can inspect and modifySti the given expression.
 ...
 * methods declared in class <code>Point</code>.  This code does not modifySti
 ...
 *
 * @see net.daichang.starlightbyte.javassist.CtClass#instrument(ExprEditor)
 * @see net.daichang.starlightbyte.javassist.CtMethod#instrument(ExprEditor)
 * @see net.daichang.starlightbyte.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
