...
import net.daichang.starlightbyte.javassist.bytecode.ClassFile;
...
import net.daichang.starlightbyte.javassist.compiler.SymbolTable;
...
public class CtField extends CtMember {
     ...
     * @see net.daichang.starlightbyte.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
    @Override
     ...
     *
     * @see CodeConverter
     * @see net.daichang.starlightbyte.javassist.expr.ExprEditor
     */
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see net.daichang.starlightbyte.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see net.daichang.starlightbyte.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
