...
import net.daichang.starlightbyte.javassist.bytecode.LineNumberAttributeBuilder;
import net.daichang.starlightbyte.javassist.compiler.ast.*;
...
public class JvstCodeGenWitlLineNumber extends JvstCodeGen {
    ...
    @Override
    public void atStringL(net.daichang.starlightbyte.javassist.compiler.ast.StringL s) throws CompileError {
        lineNumberAttributeBuilder.put(bytecode.currentPc(), s);
        super.atStringL(s);
    }
