...
package net.daichang.starlightbyte.javassist.tools.rmi;
...
import net.daichang.starlightbyte.javassist.CtNewConstructor;
...
public class StubGenerator implements Translator {
     ...
     *
     * @see net.daichang.starlightbyte.javassist.Translator#start(ClassPool)
     */
    @Override
     ...
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see net.daichang.starlightbyte.javassist.Translator#onLoad(ClassPool,String)
     */
    @Override
