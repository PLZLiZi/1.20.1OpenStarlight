 ...
 * an exception.
 *
 * @see net.daichang.starlightbyte.javassist.tools.reflect.Metaobject#trapMethodcall(int, Object[])
 * @see net.daichang.starlightbyte.javassist.tools.reflect.ClassMetaobject#trapMethodcall(int, Object[])
 * @see net.daichang.starlightbyte.javassist.tools.reflect.ClassMetaobject#invoke(Object, int, Object[])
 */
