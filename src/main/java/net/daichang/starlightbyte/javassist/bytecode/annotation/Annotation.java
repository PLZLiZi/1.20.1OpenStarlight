...
package net.daichang.starlightbyte.javassist.bytecode.annotation;
 ...
 *
 * @see net.daichang.starlightbyte.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see net.daichang.starlightbyte.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see net.daichang.starlightbyte.javassist.bytecode.AnnotationDefaultAttribute
     */
