 ...
 * @see MethodInfo
 * @see ClassFileWriter
 * @see net.daichang.starlightbyte.javassist.CtClass#getClassFile()
 * @see net.daichang.starlightbyte.javassist.ClassPool#makeClass(ClassFile)
 */
public final class ClassFile {
     ...
     * 
     * @see net.daichang.starlightbyte.javassist.bytecode.AccessFlag
     */
