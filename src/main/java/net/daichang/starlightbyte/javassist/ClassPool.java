...
import net.daichang.starlightbyte.javassist.util.proxy.DefinePackageHelper;
 ...
 *
 * @see net.daichang.starlightbyte.javassist.CtClass
 * @see net.daichang.starlightbyte.javassist.ClassPath
 */
...
public class ClassPool {
     ...
     * @see net.daichang.starlightbyte.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see net.daichang.starlightbyte.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see net.daichang.starlightbyte.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see net.daichang.starlightbyte.javassist.ByteArrayClassPath
     */
     ...
     * @see net.daichang.starlightbyte.javassist.ClassPath
     * @see net.daichang.starlightbyte.javassist.URLClassPath
     * @see net.daichang.starlightbyte.javassist.ByteArrayClassPath
     */
    ...
    {
        try {
            return net.daichang.starlightbyte.javassist.util.proxy.DefineClassHelper.toClass(neighbor,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
    ...
    {
        try {
            return net.daichang.starlightbyte.javassist.util.proxy.DefineClassHelper.toClass(lookup,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
            throw new CannotCompileException(e);
    ...
    {
        try {
            return net.daichang.starlightbyte.javassist.util.proxy.DefineClassHelper.toClass(ct.getName(),
