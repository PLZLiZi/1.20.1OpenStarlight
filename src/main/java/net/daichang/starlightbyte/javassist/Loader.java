 ...
 *
 * @see net.daichang.starlightbyte.javassist.ClassPool
 * @see net.daichang.starlightbyte.javassist.Translator
 */
public class Loader extends ClassLoader {
     ...
     *
     * @see net.daichang.starlightbyte.javassist.Loader#run(String[])
     */
    public static void main(String[] args) throws Throwable {
