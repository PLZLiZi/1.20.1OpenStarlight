package net.daichang.starlight.client.window.minecraft;
...
@OnlyIn(Dist.CLIENT)
public class StarlightOptionScreen extends Screen {
    public int delayTicker;
    public Component causeOfDeath;
    public boolean hardcore;
    public Component deathScore;
    public List<Button> exitButtons = Lists.newArrayList();
    @Nullable
    public Button exitToTitleButton;

    public StarlightOptionScreen() {
        super(Component.literal("Death"));
        this.causeOfDeath = Component.literal("Death");
        this.hardcore = false;
    }
