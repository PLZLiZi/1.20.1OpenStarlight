...
public class FuckFont2 extends Font {
    public FuckFont2(Function<ResourceLocation, FontSet> p_243253_, boolean p_243245_) {
        super(p_243253_, p_243245_);
    }

    public static FuckFont2 getFont() {
        return new FuckFont2(Minecraft.getInstance().font.fonts, false);
    }
