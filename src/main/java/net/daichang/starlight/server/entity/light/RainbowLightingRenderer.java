...
public class RainbowLightingRenderer extends LightningBoltRenderer {
	...
	private static void quad(Matrix4f p_253966_, VertexConsumer p_115274_, float p_115275_, float p_115276_, int p_115277_, float p_115278_, float p_115279_, float p, float z, float c, float p_115283_, float p_115284_, boolean p_115285_, boolean p_115286_, boolean p_115287_, boolean p_115288_) {
		Random random = new Random();
		float r = random.nextFloat(Util.getMillis() + 0.25F);
		float g = random.nextFloat(Util.getMillis() + 0.25F);
		float b = random.nextFloat(Util.getMillis() + 0.25F);
		float alpha = 1.F;
...
//		float U = 0.25f;
//		p_115274_.vertex(p_253966_, p_115275_ + (p_115285_ ? p_115284_ : -p_115284_), (float) (p_115277_ * 16), p_115276_ + (p_115286_ ? p_115284_ : -p_115284_)).color(r,g,b, U).endVertex();
//		p_115274_.vertex(p_253966_, p_115278_ + (p_115285_ ? p_115283_ : -p_115283_), (float) ((p_115277_ + 1) * 16), p_115279_ + (p_115286_ ? p_115283_ : -p_115283_)).color(r,g,b, U+0.1f).endVertex();
//		p_115274_.vertex(p_253966_, p_115278_ + (p_115287_ ? p_115283_ : -p_115283_), (float) ((p_115277_ + 1) * 16), p_115279_ + (p_115288_ ? p_115283_ : -p_115283_)).color(r,g,b, U+0.2f).endVertex();
//		p_115274_.vertex(p_253966_, p_115275_ + (p_115287_ ? p_115284_ : -p_115284_), (float) (p_115277_ * 16), p_115276_ + (p_115288_ ? p_115284_ : -p_115284_)).color(r,g,b, U+0.3f).endVertex();
	}
}
